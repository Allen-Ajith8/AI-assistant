...
val ElectricBlue = Color(0xFFFF8C00)       // iQOO Orange (secondary accent)
val TextHighContrast = Color(0xFFFFFFFF)   // White text
val TextMuted = Color(0xFF9E9E9E)          // Grey text
val ErrorRed = Color(0xFFFF4444)           // Error red
